$(function(){
    $('.slider-item').slick({
        prevArrow: '<img src="images/arrow-left-big.svg"  class="slider-item__arrow slider-item__arrow--left" alt="back slide">',
        nextArrow: '<img src="images/arrow-right-big.svg"  class="slider-item__arrow slider-item__arrow--right" alt="next slide">',
        autoplay: true,
        autoplaySpeed: 5000,
    });
    ...
    $('.news__titles-item').on('click', function(e){
        ...
        $($(this).find('a.news__title-link').attr('href')).addClass('article__box--active');
    });

    $('.menu-adaptive__burger-btn').on('click', function(){
        $('.menu-adaptive__list').toggleClass('menu-adaptive__list--active');
        $('.menu-adaptive__salons-list').removeClass('menu-adaptive__salons-list--active');
    });

    $('.menu-adaptive__salons-hover-link').on('click', function(){
        $('.menu-adaptive__salons-list').toggleClass('menu-adaptive__salons-list--active');
    });
})